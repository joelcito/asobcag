            ...
            <div class="modal-body scroll-y">
                <form id="formularioCategoria">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                <label class="required fw-semibold fs-6 mb-2">Sigla</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                <label class="required fw-semibold fs-6 mb-2">Desde</label>
                                <input type="number" class="form-control form-control-sm" id="desde" name="desde">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="fv-row mb-7">
                                <label class="required fw-semibold fs-6 mb-2">Hasta</label>
                                <input type="number" class="form-control form-control-sm" id="hasta" name="hasta">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="card">
                <div class="card-header flex-wrap bg-light-info py-4">
                    <div id="kt_app_toolbar_container" class="app-container container-xxlg d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            <!--begin::Title-->
                            <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">LISTADO DE CATEGORIAS</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Page title-->
                        ...
                        <div class="d-flex gap-2 gap-lg-3">
                            <a class="btn btn-sm fw-bold btn-primary" onclick="modalNuevoCategoria()"><i class="fa fa-plus"></i>Nueva Categoria</a>
                        </div>
