                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="fv-row mb-7">
                                    ...
                                    <select data-control="select2" data-placeholder="Seleccione"
                                        data-dropdown-parent="#modalMedicacion"
                                        class="form-select form-select-solid fw-bold" name="producto_veterinario_id"
                                        id="producto_veterinario_id">
                                        <option></option>
                                        @foreach ($productos as $producto)
                                            <option value="{{ $producto->id }}">{{ $producto->nombre }}</option>
                                        @endforeach
                                    </select>
                                    <input type="hidden" name="ejemplar_id_medicacion" id="ejemplar_id_medicacion"
                            ...
                            <div class="col-md-4">
                                <div class="fv-row mb-7">
                                    ...
                                    <select data-control="select2" data-placeholder="Seleccione"
                                        data-dropdown-parent="#modalMedicacion"
                                        class="form-select form-select-solid fw-bold" name="responsable_id"
                                        id="responsable_id">
                                        <option></option>
                                        @foreach ($usuarios as $responsable)
                                            <option value="{{ $responsable->id }}">
                                                {{ $responsable->nombres . ' ' . $responsable->ap_paterno }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="dosis"
                                        name="dosis">
                            ...
                            <div class="col-md-4">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="unidades"
                                        name="unidades">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="motivo_morfologico" id="motivo_morfologico"
                                ...
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Fecha</label>
                                        <input type="date" class="form-control form-control-sm" id="fecha_morfologico"
                                            name="fecha_morfologico" required>
                                ...
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select data-control="select2" data-placeholder="Seleccione"
                                            data-dropdown-parent="#modalRegistroMorfologico"
                                            class="form-select form-select-solid fw-bold" name="evaluador_id_morfologico"
                                            id="evaluador_id_morfologico" required required>
                                            <option></option>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="oreja_morfologico"
                                            name="oreja_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="cuello_morfologico" name="cuello_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="cabeza_morfologico" name="cabeza_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="alzada_morfologico" name="alzada_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="largo_cuerpo_morfologico" name="largo_cuerpo_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="amplitud_pecho_morfologico" name="amplitud_pecho_morfologico" required>
                                        <div class="text-danger error-message" id="error-amplitud_pecho_morfologico">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="fortaleza_morfologico" name="fortaleza_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="balance_morfologico" name="balance_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="canias_morfologico" name="canias_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="copete_morfologico" name="copete_morfologico" required>
                                ...
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="linea_superior_morfologico" name="linea_superior_morfologico" required>
                                        <div class="text-danger error-message" id="error-linea_superior_morfologico">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="grupa_morfologico"
                                            name="grupa_morfologico" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-sm w-100 btn-success"
                                    onclick="guardarMorfologico()">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="motivo_morfologico_alpaca" id="motivo_morfologico_alpaca"
                                ...
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="date" class="form-control form-control-sm"
                                            id="fecha_morfologico_alpaca" name="fecha_morfologico_alpaca" required>
                                ...
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select data-control="select2" data-placeholder="Seleccione"
                                            ...
                                            name="evaluador_id_morfologico_alpaca" id="evaluador_id_morfologico_alpaca"
                                            required required>
                                            <option></option>
                                            @foreach ($usuarios as $usuario)
                                                <option value="{{ $usuario->id }}">{{ $usuario->name }}</option>
                                        ...
                                        <div class="text-danger error-message" id="error-evaluador_id_morfologico_alpaca">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="densidad_morfologico_alpaca" name="densidad_morfologico_alpaca" required>
                                        <div class="text-danger error-message" id="error-densidad_morfologico_alpaca">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="rizo_morfologico_alpaca" name="rizo_morfologico_alpaca" required>
                                ...
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Cabeza</label>
                                        <input type="text" class="form-control form-control-sm"
                                            id="cabeza_morfologico_alpaca" name="cabeza_morfologico_alpaca" required>
                                ...
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="calce_morfologico_alpaca" name="calce_morfologico_alpaca" required>
                                ...
                                <div class="col-md-3">
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Balance</label>
                                        <input type="text" class="form-control form-control-sm"
                                            id="balance_morfologico_alpaca" name="balance_morfologico_alpaca" required>
                                        <div class="text-danger error-message" id="error-balance_morfologico_alpaca">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-sm w-100 btn-success"
                                    onclick="guardarMorfologicoAlpaca()">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-sm w-100 btn-success"
                                    onclick="guardarBiometria()">Guardar</button>
                            </div>
                        </div>
                    </div>
                    <!--end::Modal body-->
                ...
                <div class="modal-content">
                        ...
                        <form id="formularioRegistroBiometricoAlpaca">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="motivo_alpaca" id="motivo_alpaca"
                                            class="form-control form-control-sm" required>
                                            <option value="Nacimiento">Nacimiento</option>
                                            <option value="Destete">Destete</option>
                                            <option value="Otro">Otro</option>
                                ...
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Fecha</label>
                                        <input type="date" class="form-control form-control-sm" id="fecha_alpaca"
                                            name="fecha_alpaca" required>
                                ...
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select data-control="select2" data-placeholder="Seleccione"
                                            data-dropdown-parent="#modalRegistroBiometrico"
                                            class="form-select form-select-solid fw-bold" name="evaluador_id_alpaca"
                                            id="evaluador_id_alpaca" required required>
                                            <option></option>
                                            @foreach ($usuarios as $usuario)
                                                <option value="{{ $usuario->id }}">{{ $usuario->name }}</option>
                                                |
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Peso</label>
                                        <input type="text" class="form-control form-control-sm" id="peso_alpaca"
                                            name="peso_alpaca" required>
                                ...
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="altura_cruz_alpaca" name="altura_cruz_alpaca" required>
                                ...
                                <div class="col-md-4">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            id="talla_cabeza_alpaca" name="talla_cabeza_alpaca" required>
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="btn btn-sm w-100 btn-success"
                                    onclick="guardarBiometriaAlpaca()">Guardar</button>
                            </div>
                        </div>
                    </div>
                    <!--end::Modal body-->
            ...
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    ...
                                    <select data-control="select2" data-placeholder="Seleccione"
                                        data-dropdown-parent="#modalRegistroFibras"
                                        class="form-select form-select-solid fw-bold" name="laboratorio_id"
                                        id="laboratorio_id" required required>
                                        <option></option>
                            ...
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    ...
                                    <select data-control="select2" data-placeholder="Seleccione"
                                        data-dropdown-parent="#modalRegistroFibras"
                                        class="form-select form-select-solid fw-bold" name="equipo_id" id="equipo_id"
                                        required required>
                                        <option></option>
                            ...
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="date" class="form-control form-control-sm" id="fecha_muestreo"
                                        name="fecha_muestreo" required>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="zona_corporal"
                                        name="zona_corporal" required>
                            ...
                            <div class="col-md-1">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="fd"
                                        name="fd" required>
                            ...
                            <div class="col-md-1">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="sd"
                                        name="sd" required>
                            ...
                            <div class="col-md-1">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="cv"
                                        name="cv" required>
                            ...
                            <div class="col-md-1">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="pm"
                                        name="pm" required>
                            ...
                            <div class="col-md-1">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="mfd"
                                        name="mfd" required>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-sm w-100 btn-success"
                                onclick="guardarFibra()">Guardar</button>
                        </div>
                    </div>
                </div>
                <!--end::Modal body-->
            ...
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    ...
                                    <select data-control="select2" data-placeholder="Seleccione"
                                        data-dropdown-parent="#modalRegistroEsquila"
                                        class="form-select form-select-solid fw-bold" name="esquilador_id"
                                        id="esquilador_id" required required>
                                        <option></option>
                                        @foreach ($usuarios as $usuario)
                                            <option value="{{ $usuario->id }}">{{ $usuario->name }}</option>
                                            |
                            ...
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    <label class="required fw-semibold fs-6 mb-2">Fecha</label>
                                    <input type="date" class="form-control form-control-sm" id="fecha_esquila"
                                        name="fecha_esquila" required>
                            ...
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="tipo_esquila"
                                        name="tipo_esquila" required>
                            ...
                            <div class="col-md-3">
                                <div class="fv-row mb-7">
                                    <div class="form-check form-switch form-check-custom form-check-solid mt-9">
                                        <input class="form-check-input" type="checkbox" id="inca_esquila"
                                            name="inca_esquila" />
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="peso_manto"
                                        name="peso_manto" required>
                            ...
                            <div class="col-md-2">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="peso_cuello"
                                        name="peso_cuello" required>
                            ...
                            <div class="col-md-2">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="peso_braga"
                                        name="peso_braga" required>
                            ...
                            <div class="col-md-2">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="peso_total"
                                        name="peso_total" required>
                ...
                <div class="modal-footer">
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-sm w-100 btn-success"
                                onclick="guardarEsquila()">Guardar</button>
                        </div>
                    </div>
                </div>
                <!--end::Modal body-->
                    ...
                    error: function(xhr) {
                        if (xhr.status === 422) {
                            ...
                            $.each(errors, function(key, messages) {
                                ...
                                if (input.length > 0) {
                                    input.addClass(
                                    'is-invalid'); // Agregar clase de error
                                    errorDiv.html('<span>' + messages[0] +
                                    '</span>'); // Mostrar mensaje
                                }
                            });
                        }
                    }
                ...
                if (archivos.length > 0) {
                    ...
                    archivos.forEach((archivo) => {
                        ...
                        reader.onload = function(e) {
                            ...
                            cuadro.classList.add("d-flex", "flex-column", "align-items-center",
                                "border", "p-1", "m-1");
                            ...
                            cuadro.querySelector(".eliminarImagen").addEventListener("click",
                                function() {
